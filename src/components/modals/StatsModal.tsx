      ...
      {(isGameLost || isGameWon) && (
        <div className="mt-5 columns-2 items-center items-stretch justify-center text-center dark:text-white sm:mt-6">
          ...
          <div>
            <button
              type="button"
              className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-claret-600 px-4 py-2 text-center text-sm font-medium text-white shadow-sm hover:bg-claret-700 focus:outline-none focus:ring-2 focus:ring-claret-500 focus:ring-offset-2 sm:text-base"
              onClick={() => {
                shareStatus(
                  guesses,
                  incorrectGuesses,
